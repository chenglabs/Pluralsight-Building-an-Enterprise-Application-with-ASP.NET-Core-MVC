...
namespace BethanysPieShop.Controllers
{
    ...
    public class PieManagementController : Controller
    {
        ...
        public IActionResult AddPie(PieEditViewModel pieEditViewModel)
        {
            ...
            {
                ModelState.AddModelError(nameof(pieEditViewModel.Pie.Price),
                    "The price of the pie should be higher than 0.");
            }

            if (pieEditViewModel.Pie.IsPieOfTheWeek && !pieEditViewModel.Pie.InStock)
            {
                ModelState.AddModelError(nameof(pieEditViewModel.Pie.IsPieOfTheWeek),
                    "Only pies that are in stock should be Pie of the Week.");
            }
